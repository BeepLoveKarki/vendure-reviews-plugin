...
export declare type MutationSubmitProductReviewArgs = {
...
export declare type QueryGenerateBraintreeClientTokenArgs = {
    orderId: Scalars['ID'];
};
...
export declare type SubmitProductReviewInput = {
    productId: Scalars['ID'];
